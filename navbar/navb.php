...
<div class="sidebar bg-dark" >
  ...
  <a href="../bankgo/transaction.php" class="text-white mb-1 mx-1" id="active4" title="Transaction"><i class="bi bi-file-text"></i> <span class="c5">  Transaction </span><span class="span3 badge text-bg-primary "><?php $h = $row['cnt'];
  if($h == 0){
