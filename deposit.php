                ...
                <h3>Enter amount to Deposit:</h3>
                    ...
                    <div class="d-grid col-8 mx-auto">
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control form-control-lg bg-dark text-light" min="1" placeholder="0" name="deposit-data" id="deposit-data" required>        
                        </div>
                    </div>
                    </form>
                    <div class="d-grid col-6 mx-auto">
                        <button class="btn btn-primary border border-light" id="upt1">Deposit</button>
                    </div>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function(){
        ...
        $("#upt1").click(function(){
            ...
            var deposit = $("#deposit-data").val();
                ...
                $.ajax({
                url : "/bankgo/data/deposit-data.php",
                type : "POST",
                data : fdata,
                dataType : "json",
